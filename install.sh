...
LINUX_LINKS=(
  ...
  "chrome/chrome-flags.conf:$HOME/.config/chrome-flags.conf"
  "xdg/mimeapps.list:$HOME/.config/mimeapps.list"
  "autostart/org.fcitx.Fcitx5.desktop:$HOME/.config/autostart/org.fcitx.Fcitx5.desktop"
  "autostart/limine-snapper-notify.desktop:$HOME/.config/autostart/limine-snapper-notify.desktop"
  "autostart/print-applet.desktop:$HOME/.config/autostart/print-applet.desktop"
  ...
  "omarchy/plugins/jwage.workspaces/focus-window:$HOME/.config/omarchy/plugins/jwage.workspaces/focus-window"
